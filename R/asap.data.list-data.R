#' asap.data.list
#'
#' @description The American State Administrator's Project (ASAP) survey asks administrators about the influence of a variety of external political actors including "clientele groups" in their agencies., see page 395.
#'
...
#' \item\code{medt.contr} interaction variable betweenmed.time and contracting.
